...
function EnderecoDoador(){
  ...
  const handleBuy = () => {
    ...
    navigation.navigate("SuccessfulyDoador");
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titleCart}>Informe seus dados para retirada.</Text>
        <TextInput
