    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.menu}>
          ...
          style={styles.cart}
          onPress={() => {
            navigation.navigate('CartDoador', cart);
          }}
          >
          ...
          <Menu style={{ borderRadius: 16 }}>
            ...
            <MenuOptions style={styles.menuList}>
              <MenuOption style={styles.menuItem} onSelect={() => navigation.navigate("ListItemDoador")}>
                <Feather name="home" size={15} />
                <Text style={styles.textMenu}>Inicio</Text>
              </MenuOption>
              <MenuOption style={styles.menuItem} onSelect={() => navigation.navigate("ProductListDoador")}>
                <Feather name="list" size={15} />
                <Text style={styles.textMenu}>Pedidos</Text>
              </MenuOption>
              <MenuOption style={styles.menuItem} onSelect={() => navigation.navigate("ProfileDoador")}>
